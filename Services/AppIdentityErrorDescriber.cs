...
{
    /*
        Tùy biến các thông báo lỗi của Identity (khi submit form, create, update, delete,...)  
        Nhớ đăng ký lại trong service tùy biến này vào container trong Program.cs (Singleton)
    */
    public class AppIdentityErrorDescriber : IdentityErrorDescriber
    {
        public override IdentityError DuplicateRoleName(string role)
        {
            ...
            {
                Code = error.Code,
                Description = $"Vai trò {role} đã tồn tại trong hệ thống"
            };
        }
